...
CREATE TABLE serie(
	idSerie BIGINT(11) NOT NULL AUTO_INCREMENT,
	idMarca BIGINT(11) NOT NULL,
	nome VARCHAR(30) NOT NULL,
	PRIMARY KEY(idSerie),
...
CREATE TABLE produto(
	...
	FOREIGN KEY(serie) REFERENCES serie(idSerie) ON DELETE CASCADE ON UPDATE CASCADE
);
